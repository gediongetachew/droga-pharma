...
export default function OurBranch() {
  return (
    ...
    <Grid container sx={{background:'white',  paddingTop:10}}>
     <Grid item xs={12} sx={{display:'flex',flexDirection:{xs:'column', md:'row'}, justifyContent:'space-between', paddingX:{xs:1, md:10},paddingTop:{xs:2, md:10}}}>
        <Typography sx={{fontSize:{xs:'30px',md:'48px'}, fontFamily:'Plus Jakarta Sans', color:'black', width:{xs:'100', md:'45%'}}}>Our Brands</Typography>
        <Typography sx={{fontSize:{xs:'12px',md:'24px'}, fontFamily:'Plus Jakarta Sans',color:'gray', width:{xs:'100', md:'55%'}}}>Lorem ipsum dolor sit amet consectetur. Tristique dignissim sed diam eros hac risus pharetra quis. Eu sollicitudin ut quis a. Viverra fusce sem amet feugiat nibh pellentesque scelerisque scelerisque. Sed aliquam id faucibus integer pellentesque elementum risus ornare.</Typography>
     </Grid>
     <Grid item md={12}>
       <Grid container sx={{display:'flex', paddingX:{xs:1, md:6},marginTop:{xs:3, md:0}}}>
        ...
        <Grid
                ...
                xs={12}
                md={5.5}
                sx={{ display: 'flex', flexDirection: 'column', padding: {xs:1, md:10}, gap:2 }}
              >
                <Typography
                  sx={{
     ...
     <Grid item md={12}>
       <Grid container sx={{display:'flex', paddingX:{xs:2, md:6},}}>
        ...
        <Grid
                ...
                xs={12}
                md={5.5}
                sx={{ display: 'flex', flexDirection: 'column', padding: {xs:2, md:10}, gap:2 }}
              >
                <Typography
                  sx={{
                    fontSize: { xs: '20px', md: '32px' },
